 ...
 * @description chat/room-governance｜application/usecases/admin-actions：bans。
 */

import type { ChannelBan, RemoveChannelBanOutcome, SetChannelBanOutcome } from "@/features/chat/room-governance/domain/contracts";
import { rejectGovernanceCommand } from "../../outcomes/governanceCommandOutcome";
import { mapApiBan } from "../../mappers/apiMappers";
