 ...
 * @description chat/room-governance｜application/admin-actions：context。
 */

import type { GovernanceApiPort } from "../ports";
import type { CreateScopeGuard } from "../scopeGuard";
export type { ScopeGuard, CreateScopeGuard } from "../scopeGuard";
export { createScopeGuardFactory } from "../scopeGuard";
