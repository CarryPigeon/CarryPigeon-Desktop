 ...
 * @description chat/room-governance｜application/admin-actions：applications。
 */

import type { ChannelApplication, DecideChannelApplicationOutcome } from "@/features/chat/room-governance/contracts";
import { rejectGovernanceCommand } from "../governanceCommandOutcome";
import { mapApiApplication } from "../apiMappers";
