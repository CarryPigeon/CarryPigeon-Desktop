...
import type { ChatCenterModel } from "@/features/chat/presentation/composables/useChatCenterModel";
...
import ComposerHost from "@/features/chat/presentation/components/composer/ComposerHost.vue";
