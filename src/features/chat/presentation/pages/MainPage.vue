...
import ServerRail from "@/features/chat/presentation/components/layout/ServerRail.vue";
import ChannelRail from "@/features/chat/presentation/components/layout/ChannelRail.vue";
import MembersRail from "@/features/chat/presentation/components/layout/MembersRail.vue";
import ChannelSettingsMenu from "@/features/chat/presentation/components/menus/ChannelSettingsMenu.vue";
import ChatCenter from "@/features/chat/presentation/components/layout/ChatCenter.vue";
import { usePatchbayPageModel } from "@/features/chat/presentation/composables/usePatchbayPageModel";
import MessageContextMenu from "@/features/chat/presentation/components/menus/MessageContextMenu.vue";
import QuickSwitcher from "@/features/chat/presentation/components/overlay/QuickSwitcher.vue";
import CreateChannelDialog from "@/features/chat/presentation/components/dialogs/CreateChannelDialog.vue";
import DeleteChannelDialog from "@/features/chat/presentation/components/dialogs/DeleteChannelDialog.vue";
