...
前置依赖：
- `server_id` 来源：`docs/design/protocol/PROTOCOL-OVERVIEW.md`
- 插件目录与 required gate：`docs/design/protocol/PLUGIN-CATALOG-AND-ERRORS.md`
- 插件包结构与可执行性：`docs/design/client/PLUGIN-PACKAGE-STRUCTURE.md`
- 插件运行时：`docs/design/client/PLUGIN-RUNTIME.md`
